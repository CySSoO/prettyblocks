    ...
    public function indexAction()
    {
        ...
        return $this->render('@Modules/prettyblocks/views/templates/admin/index.html.twig', [
            ...
            'trans_app' => [
                ...
                'block_help' => $translator->trans('Block help', [], 'Modules.Prettyblocks.Admin'),
                'block_help_title' => $translator->trans('Block usage', [], 'Modules.Prettyblocks.Admin'),
                ...
                'layout_manager' => $translator->trans('Layout manager', [], 'Modules.Prettyblocks.Admin'),
                'rename_template' => $translator->trans('Rename template', [], 'Modules.Prettyblocks.Admin'),
                'delete_template' => $translator->trans('Delete template', [], 'Modules.Prettyblocks.Admin'),
                'template_update_error' => $translator->trans('Unable to update this template.', [], 'Modules.Prettyblocks.Admin'),
                'template_delete_error' => $translator->trans('Unable to delete this template.', [], 'Modules.Prettyblocks.Admin'),
                'template_updated' => $translator->trans('Template updated successfully.', [], 'Modules.Prettyblocks.Admin'),
                'template_deleted' => $translator->trans('Template deleted successfully.', [], 'Modules.Prettyblocks.Admin'),
                'confirm_delete_template' => $translator->trans('Do you really want to delete this template?', [], 'Modules.Prettyblocks.Admin'),
                'target_hook_label' => $translator->trans('Target hook', [], 'Modules.Prettyblocks.Admin'),
                'saved_zone_label' => $translator->trans('Saved zone', [], 'Modules.Prettyblocks.Admin'),
                'inject_template' => $translator->trans('Inject template', [], 'Modules.Prettyblocks.Admin'),
                'refresh_templates' => $translator->trans('Refresh list', [], 'Modules.Prettyblocks.Admin'),
            ],
            'security_app' => [
